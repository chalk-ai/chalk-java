...
@javax.annotation.Generated(
    ...
    comments = "Source: chalk/manager/v1/builder.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ClusterBuilderServiceGrpc {

  private ClusterBuilderServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "chalk.manager.v1.ClusterBuilderService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest,
      ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse> getCreateKafkaTopicsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateKafkaTopics",
      requestType = ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest.class,
      responseType = ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest,
      ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse> getCreateKafkaTopicsMethod() {
    io.grpc.MethodDescriptor<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest, ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse> getCreateKafkaTopicsMethod;
      ...
      synchronized (ClusterBuilderServiceGrpc.class) {
        if ((getCreateKafkaTopicsMethod = ClusterBuilderServiceGrpc.getCreateKafkaTopicsMethod) == null) {
          ClusterBuilderServiceGrpc.getCreateKafkaTopicsMethod = getCreateKafkaTopicsMethod =
              io.grpc.MethodDescriptor.<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest, ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateKafkaTopics"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest,
      ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse> getGetKafkaTopicsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetKafkaTopics",
      requestType = ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest.class,
      responseType = ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest,
      ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse> getGetKafkaTopicsMethod() {
    io.grpc.MethodDescriptor<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest, ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse> getGetKafkaTopicsMethod;
      ...
      synchronized (ClusterBuilderServiceGrpc.class) {
        if ((getGetKafkaTopicsMethod = ClusterBuilderServiceGrpc.getGetKafkaTopicsMethod) == null) {
          ClusterBuilderServiceGrpc.getGetKafkaTopicsMethod = getGetKafkaTopicsMethod =
              io.grpc.MethodDescriptor.<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest, ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetKafkaTopics"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createKafkaTopics(ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateKafkaTopicsMethod(), responseObserver);
    }

    /**
     */
    default void getKafkaTopics(ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse> responseObserver) {
  ...
  public static final class ClusterBuilderServiceStub
    ...
    /**
     */
    public void createKafkaTopics(ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse> responseObserver) {
    ...
    /**
     */
    public void getKafkaTopics(ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ClusterBuilderServiceBlockingStub
    ...
    /**
     */
    public ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse createKafkaTopics(ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest request) {
    ...
    /**
     */
    public ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse getKafkaTopics(ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ClusterBuilderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse> createKafkaTopics(
        ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse> getKafkaTopics(
        ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_KAFKA_TOPICS:
          serviceImpl.createKafkaTopics((ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest) request,
              (io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse>) responseObserver);
          break;
        case METHODID_GET_KAFKA_TOPICS:
          serviceImpl.getKafkaTopics((ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest) request,
              (io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsRequest,
              ai.chalk.protos.chalk.manager.v1.CreateKafkaTopicsResponse>(
                service, METHODID_CREATE_KAFKA_TOPICS)))
        .addMethod(
          getGetKafkaTopicsMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsRequest,
              ai.chalk.protos.chalk.manager.v1.GetKafkaTopicsResponse>(
  ...
  private static abstract class ClusterBuilderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ai.chalk.protos.chalk.manager.v1.BuilderProto.getDescriptor();
    }
