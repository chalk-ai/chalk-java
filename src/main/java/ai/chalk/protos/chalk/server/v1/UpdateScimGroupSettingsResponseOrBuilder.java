...
public interface UpdateScimGroupSettingsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:chalk.server.v1.UpdateScimGroupSettingsResponse)
