...
@java.lang.Deprecated public interface TimeSeriesChartOrBuilder extends
    // @@protoc_insertion_point(interface_extends:chalk.server.v1.TimeSeriesChart)
   ...
   */
  java.util.List<ai.chalk.protos.chalk.server.v1.TimeSeries> 
      getSeriesList();
  /**
   * <code>repeated .chalk.server.v1.TimeSeries series = 2 [json_name = "series"];</code>
   */
  ai.chalk.protos.chalk.server.v1.TimeSeries getSeries(int index);
  /**
   * <code>repeated .chalk.server.v1.TimeSeries series = 2 [json_name = "series"];</code>
   */
  int getSeriesCount();
   ...
   * <code>repeated .chalk.server.v1.TimeSeries series = 2 [json_name = "series"];</code>
   */
  java.util.List<? extends ai.chalk.protos.chalk.server.v1.TimeSeriesOrBuilder> 
      getSeriesOrBuilderList();
  /**
   * <code>repeated .chalk.server.v1.TimeSeries series = 2 [json_name = "series"];</code>
   */
  ai.chalk.protos.chalk.server.v1.TimeSeriesOrBuilder getSeriesOrBuilder(
      int index);
