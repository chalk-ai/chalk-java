...
/**
 * Protobuf type {@code chalk.server.v1.GetHealthResponse}
 */
public final class GetHealthResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:chalk.server.v1.GetHealthResponse)
    GetHealthResponseOrBuilder {
private static final long serialVersionUID = 0L;
  // Use GetHealthResponse.newBuilder() to construct.
  private GetHealthResponse(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ai.chalk.protos.chalk.server.v1.StatusProto.internal_static_chalk_server_v1_GetHealthResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ai.chalk.protos.chalk.server.v1.StatusProto.internal_static_chalk_server_v1_GetHealthResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ai.chalk.protos.chalk.server.v1.GetHealthResponse.class, ai.chalk.protos.chalk.server.v1.GetHealthResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ai.chalk.protos.chalk.server.v1.GetHealthResponse)) {
      return super.equals(obj);
    }
    ai.chalk.protos.chalk.server.v1.GetHealthResponse other = (ai.chalk.protos.chalk.server.v1.GetHealthResponse) obj;
  ...
  public static ai.chalk.protos.chalk.server.v1.GetHealthResponse parseFrom(
  ...
  public static ai.chalk.protos.chalk.server.v1.GetHealthResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ai.chalk.protos.chalk.server.v1.GetHealthResponse parseFrom(
  ...
  public static ai.chalk.protos.chalk.server.v1.GetHealthResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ai.chalk.protos.chalk.server.v1.GetHealthResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static ai.chalk.protos.chalk.server.v1.GetHealthResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ai.chalk.protos.chalk.server.v1.GetHealthResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:chalk.server.v1.GetHealthResponse)
      ai.chalk.protos.chalk.server.v1.GetHealthResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ai.chalk.protos.chalk.server.v1.StatusProto.internal_static_chalk_server_v1_GetHealthResponse_descriptor;
    }
    ...
    // Construct using ai.chalk.protos.chalk.server.v1.GetHealthResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public ai.chalk.protos.chalk.server.v1.GetHealthResponse getDefaultInstanceForType() {
      return ai.chalk.protos.chalk.server.v1.GetHealthResponse.getDefaultInstance();
    }

    @java.lang.Override
    public ai.chalk.protos.chalk.server.v1.GetHealthResponse build() {
      ai.chalk.protos.chalk.server.v1.GetHealthResponse result = buildPartial();
    ...
    @java.lang.Override
    public ai.chalk.protos.chalk.server.v1.GetHealthResponse buildPartial() {
      ai.chalk.protos.chalk.server.v1.GetHealthResponse result = new ai.chalk.protos.chalk.server.v1.GetHealthResponse(this);
    ...
    private void buildPartialRepeatedFields(ai.chalk.protos.chalk.server.v1.GetHealthResponse result) {
      if (checksBuilder_ == null) {
    ...
    private void buildPartial0(ai.chalk.protos.chalk.server.v1.GetHealthResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ai.chalk.protos.chalk.server.v1.GetHealthResponse) {
        return mergeFrom((ai.chalk.protos.chalk.server.v1.GetHealthResponse)other);
      } else {
    ...
    public Builder mergeFrom(ai.chalk.protos.chalk.server.v1.GetHealthResponse other) {
      if (other == ai.chalk.protos.chalk.server.v1.GetHealthResponse.getDefaultInstance()) return this;
      if (checksBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:chalk.server.v1.GetHealthResponse)
  }

  // @@protoc_insertion_point(class_scope:chalk.server.v1.GetHealthResponse)
  private static final ai.chalk.protos.chalk.server.v1.GetHealthResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ai.chalk.protos.chalk.server.v1.GetHealthResponse();
  }

  public static ai.chalk.protos.chalk.server.v1.GetHealthResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<GetHealthResponse>
      PARSER = new com.google.protobuf.AbstractParser<GetHealthResponse>() {
    @java.lang.Override
    public GetHealthResponse parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
  ...
  public static com.google.protobuf.Parser<GetHealthResponse> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<GetHealthResponse> getParserForType() {
    return PARSER;
  }
