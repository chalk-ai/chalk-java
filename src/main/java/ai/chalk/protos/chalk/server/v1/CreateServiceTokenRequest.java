...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      CreateServiceTokenRequest.class.getName());
  }
  // Use CreateServiceTokenRequest.newBuilder() to construct.
  private CreateServiceTokenRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < customClaims_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, customClaims_.getRaw(i));
    }
