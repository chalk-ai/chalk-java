...
/**
 * Protobuf enum {@code chalk.metrics.v4.MetricType}
 */
public enum MetricType
  ...
  /**
   * <code>METRIC_TYPE_UP_DOWN_COUNTER = 2;</code>
   */
   ...
   * <code>METRIC_TYPE_UP_DOWN_COUNTER = 2;</code>
   */
  public static final int METRIC_TYPE_UP_DOWN_COUNTER_VALUE = 2;
  /**
   * <code>METRIC_TYPE_HISTOGRAM = 3;</code>
   */
  ...
  public static MetricType forNumber(int value) {
    switch (value) {
      ...
      case 2: return METRIC_TYPE_UP_DOWN_COUNTER;
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return ai.chalk.protos.chalk.metrics.v4.MetricsProto.getDescriptor().getEnumTypes().get(0);
  }
  ...
  // @@protoc_insertion_point(enum_scope:chalk.metrics.v4.MetricType)
}
