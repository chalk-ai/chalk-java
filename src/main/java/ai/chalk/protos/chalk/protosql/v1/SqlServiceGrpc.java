...
@javax.annotation.Generated(
    ...
    comments = "Source: chalk/protosql/v1/sql_service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class SqlServiceGrpc {

  private SqlServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "chalk.protosql.v1.SqlService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest,
      ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse> getExecuteSqlQueryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExecuteSqlQuery",
      requestType = ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest.class,
      responseType = ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest,
      ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse> getExecuteSqlQueryMethod() {
    io.grpc.MethodDescriptor<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest, ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse> getExecuteSqlQueryMethod;
      ...
      synchronized (SqlServiceGrpc.class) {
        if ((getExecuteSqlQueryMethod = SqlServiceGrpc.getExecuteSqlQueryMethod) == null) {
          SqlServiceGrpc.getExecuteSqlQueryMethod = getExecuteSqlQueryMethod =
              io.grpc.MethodDescriptor.<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest, ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExecuteSqlQuery"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest,
      ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse> getPlanSqlQueryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlanSqlQuery",
      requestType = ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest.class,
      responseType = ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest,
      ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse> getPlanSqlQueryMethod() {
    io.grpc.MethodDescriptor<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest, ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse> getPlanSqlQueryMethod;
      ...
      synchronized (SqlServiceGrpc.class) {
        if ((getPlanSqlQueryMethod = SqlServiceGrpc.getPlanSqlQueryMethod) == null) {
          SqlServiceGrpc.getPlanSqlQueryMethod = getPlanSqlQueryMethod =
              io.grpc.MethodDescriptor.<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest, ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlanSqlQuery"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void executeSqlQuery(ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getExecuteSqlQueryMethod(), responseObserver);
    }

    /**
     */
    default void planSqlQuery(ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse> responseObserver) {
  ...
  public static final class SqlServiceStub
    ...
    /**
     */
    public void executeSqlQuery(ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse> responseObserver) {
    ...
    /**
     */
    public void planSqlQuery(ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest request,
        io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class SqlServiceBlockingStub
    ...
    /**
     */
    public ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse executeSqlQuery(ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest request) {
    ...
    /**
     */
    public ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse planSqlQuery(ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SqlServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse> executeSqlQuery(
        ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse> planSqlQuery(
        ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXECUTE_SQL_QUERY:
          serviceImpl.executeSqlQuery((ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest) request,
              (io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse>) responseObserver);
          break;
        case METHODID_PLAN_SQL_QUERY:
          serviceImpl.planSqlQuery((ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest) request,
              (io.grpc.stub.StreamObserver<ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryRequest,
              ai.chalk.protos.chalk.protosql.v1.ExecuteSqlQueryResponse>(
                service, METHODID_EXECUTE_SQL_QUERY)))
        .addMethod(
          getPlanSqlQueryMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryRequest,
              ai.chalk.protos.chalk.protosql.v1.PlanSqlQueryResponse>(
  ...
  private static abstract class SqlServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ai.chalk.protos.chalk.protosql.v1.SqlServiceProto.getDescriptor();
    }
