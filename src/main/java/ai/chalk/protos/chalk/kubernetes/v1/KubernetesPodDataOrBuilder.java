...
public interface KubernetesPodDataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:chalk.kubernetes.v1.KubernetesPodData)
   ...
   * </pre>
   *
   * <code>.chalk.kubernetes.v1.KubernetesPodData.PodStatus status = 7 [json_name = "status"];</code>
   ...
   * @return The status.
   */
  ai.chalk.protos.chalk.kubernetes.v1.KubernetesPodData.PodStatus getStatus();
  /**
   * <pre>
   * string status = 7;
   * </pre>
   ...
   * <code>.chalk.kubernetes.v1.KubernetesPodData.PodStatus status = 7 [json_name = "status"];</code>
   */
  ai.chalk.protos.chalk.kubernetes.v1.KubernetesPodData.PodStatusOrBuilder getStatusOrBuilder();

  /**
   * <code>.chalk.kubernetes.v1.KubernetesPodData.PodSpec spec = 8 [json_name = "spec"];</code>
   ...
   * @return The spec.
   */
  ai.chalk.protos.chalk.kubernetes.v1.KubernetesPodData.PodSpec getSpec();
  /**
   * <code>.chalk.kubernetes.v1.KubernetesPodData.PodSpec spec = 8 [json_name = "spec"];</code>
   */
  ai.chalk.protos.chalk.kubernetes.v1.KubernetesPodData.PodSpecOrBuilder getSpecOrBuilder();
   ...
   * </pre>
   *
   * <code>int64 creation_timestamp = 18 [json_name = "creationTimestamp"];</code>
   ...
   * </pre>
   *
   * <code>int64 deletion_timestamp = 19 [json_name = "deletionTimestamp"];</code>
   ...
   * </pre>
   *
   * <code>int64 observed_timestamp = 20 [json_name = "observedTimestamp"];</code>
