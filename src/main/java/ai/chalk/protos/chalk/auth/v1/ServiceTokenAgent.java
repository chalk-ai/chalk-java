...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      ServiceTokenAgent.class.getName());
  }
  // Use ServiceTokenAgent.newBuilder() to construct.
  private ServiceTokenAgent(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public java.lang.String getCustomClaims(int index) {
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < customClaims_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, customClaims_.getRaw(i));
    }
  ...
  public static final class Builder extends
     ...
     * @return This builder for chaining.
     */
    public Builder addCustomClaimsBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureCustomClaimsIsMutable();
