...
@java.lang.Deprecated public interface GetQueryValuesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:chalk.common.v1.GetQueryValuesRequest)
   ...
   */
  ai.chalk.protos.chalk.common.v1.OperationIdTableIdentifier getOperationIdIdentifier();
  /**
   * <pre>
   * Forcing the client to specify the table name can be a bit narly. Instead, for use case 1), it can be easier to allow the client to specify the operation id,
   * and the engine can figure out what table to query.
   ...
   * <code>.chalk.common.v1.OperationIdTableIdentifier operation_id_identifier = 1 [json_name = "operationIdIdentifier"];</code>
   */
  ai.chalk.protos.chalk.common.v1.OperationIdTableIdentifierOrBuilder getOperationIdIdentifierOrBuilder();
   ...
   */
  ai.chalk.protos.chalk.common.v1.TableNameTableIdentifier getTableNameIdentifier();
  /**
   * <pre>
   * For use case 2, you have to specify which table name to look up, if you want to query across multiple queries
   * </pre>
   ...
   * <code>.chalk.common.v1.TableNameTableIdentifier table_name_identifier = 2 [json_name = "tableNameIdentifier"];</code>
   */
  ai.chalk.protos.chalk.common.v1.TableNameTableIdentifierOrBuilder getTableNameIdentifierOrBuilder();
  ...
  ai.chalk.protos.chalk.common.v1.GetQueryValuesRequest.TableIdentifierCase getTableIdentifierCase();
}
