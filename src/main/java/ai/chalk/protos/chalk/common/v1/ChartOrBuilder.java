...
public interface ChartOrBuilder extends
   ...
   */
  java.util.List<ai.chalk.protos.chalk.common.v1.Series> 
      getSeriesList();
  /**
   * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
   */
  ai.chalk.protos.chalk.common.v1.Series getSeries(int index);
  /**
   * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
   */
  int getSeriesCount();
   ...
   * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
   */
  java.util.List<? extends ai.chalk.protos.chalk.common.v1.SeriesOrBuilder> 
      getSeriesOrBuilderList();
  /**
   * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
   */
  ai.chalk.protos.chalk.common.v1.SeriesOrBuilder getSeriesOrBuilder(
      int index);
