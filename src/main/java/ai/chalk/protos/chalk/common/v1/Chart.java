...
/**
 * Protobuf type {@code chalk.common.v1.Chart}
 */
@java.lang.Deprecated public final class Chart extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:chalk.common.v1.Chart)
    ChartOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ai.chalk.protos.chalk.common.v1.ChartProto.internal_static_chalk_common_v1_Chart_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ai.chalk.protos.chalk.common.v1.ChartProto.internal_static_chalk_common_v1_Chart_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ai.chalk.protos.chalk.common.v1.Chart.class, ai.chalk.protos.chalk.common.v1.Chart.Builder.class);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<ai.chalk.protos.chalk.common.v1.Series> series_;
  /**
   * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
   */
  @java.lang.Override
  public java.util.List<ai.chalk.protos.chalk.common.v1.Series> getSeriesList() {
    return series_;
  }
  /**
   * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
   */
  @java.lang.Override
  public java.util.List<? extends ai.chalk.protos.chalk.common.v1.SeriesOrBuilder> 
   ...
   */
  @java.lang.Override
  public ai.chalk.protos.chalk.common.v1.Series getSeries(int index) {
   ...
   */
  @java.lang.Override
  public ai.chalk.protos.chalk.common.v1.SeriesOrBuilder getSeriesOrBuilder(
      int index) {
    return series_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ai.chalk.protos.chalk.common.v1.Chart)) {
      return super.equals(obj);
    }
    ai.chalk.protos.chalk.common.v1.Chart other = (ai.chalk.protos.chalk.common.v1.Chart) obj;
  ...
  public static ai.chalk.protos.chalk.common.v1.Chart parseFrom(
  ...
  public static ai.chalk.protos.chalk.common.v1.Chart parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ai.chalk.protos.chalk.common.v1.Chart parseFrom(
  ...
  public static ai.chalk.protos.chalk.common.v1.Chart parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ai.chalk.protos.chalk.common.v1.Chart parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static ai.chalk.protos.chalk.common.v1.Chart parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ai.chalk.protos.chalk.common.v1.Chart prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:chalk.common.v1.Chart)
      ai.chalk.protos.chalk.common.v1.ChartOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ai.chalk.protos.chalk.common.v1.ChartProto.internal_static_chalk_common_v1_Chart_descriptor;
    }
    ...
    // Construct using ai.chalk.protos.chalk.common.v1.Chart.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public ai.chalk.protos.chalk.common.v1.Chart getDefaultInstanceForType() {
      return ai.chalk.protos.chalk.common.v1.Chart.getDefaultInstance();
    }

    @java.lang.Override
    public ai.chalk.protos.chalk.common.v1.Chart build() {
      ai.chalk.protos.chalk.common.v1.Chart result = buildPartial();
    ...
    @java.lang.Override
    public ai.chalk.protos.chalk.common.v1.Chart buildPartial() {
      ai.chalk.protos.chalk.common.v1.Chart result = new ai.chalk.protos.chalk.common.v1.Chart(this);
    ...
    private void buildPartialRepeatedFields(ai.chalk.protos.chalk.common.v1.Chart result) {
      if (seriesBuilder_ == null) {
    ...
    private void buildPartial0(ai.chalk.protos.chalk.common.v1.Chart result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ai.chalk.protos.chalk.common.v1.Chart) {
        return mergeFrom((ai.chalk.protos.chalk.common.v1.Chart)other);
      } else {
    ...
    public Builder mergeFrom(ai.chalk.protos.chalk.common.v1.Chart other) {
      if (other == ai.chalk.protos.chalk.common.v1.Chart.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ai.chalk.protos.chalk.common.v1.Series m =
                  input.readMessage(
                      ai.chalk.protos.chalk.common.v1.Series.parser(),
                      extensionRegistry);
              if (seriesBuilder_ == null) {
                ensureSeriesIsMutable();
                series_.add(m);
    ...
    private void ensureSeriesIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        series_ = new java.util.ArrayList<ai.chalk.protos.chalk.common.v1.Series>(series_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        ai.chalk.protos.chalk.common.v1.Series, ai.chalk.protos.chalk.common.v1.Series.Builder, ai.chalk.protos.chalk.common.v1.SeriesOrBuilder> seriesBuilder_;
    ...
    public Builder setSeries(
        int index, ai.chalk.protos.chalk.common.v1.Series value) {
      if (seriesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setSeries(
        int index, ai.chalk.protos.chalk.common.v1.Series.Builder builderForValue) {
      if (seriesBuilder_ == null) {
        ensureSeriesIsMutable();
     ...
     * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
     */
    public Builder addSeries(ai.chalk.protos.chalk.common.v1.Series value) {
      if (seriesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addSeries(
        ai.chalk.protos.chalk.common.v1.Series.Builder builderForValue) {
      if (seriesBuilder_ == null) {
        ensureSeriesIsMutable();
    ...
    public Builder addAllSeries(
        java.lang.Iterable<? extends ai.chalk.protos.chalk.common.v1.Series> values) {
      if (seriesBuilder_ == null) {
        ensureSeriesIsMutable();
     ...
     * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
     */
    public ai.chalk.protos.chalk.common.v1.Series.Builder getSeriesBuilder(
        int index) {
     ...
     * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
     */
    public ai.chalk.protos.chalk.common.v1.Series.Builder addSeriesBuilder() {
      return getSeriesFieldBuilder().addBuilder(
          ai.chalk.protos.chalk.common.v1.Series.getDefaultInstance());
    }
    /**
     * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
     */
    public ai.chalk.protos.chalk.common.v1.Series.Builder addSeriesBuilder(
        int index) {
      return getSeriesFieldBuilder().addBuilder(
          index, ai.chalk.protos.chalk.common.v1.Series.getDefaultInstance());
    }
    /**
     * <code>repeated .chalk.common.v1.Series series = 2 [json_name = "series"];</code>
     */
    public java.util.List<ai.chalk.protos.chalk.common.v1.Series.Builder> 
         getSeriesBuilderList() {
      return getSeriesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        ai.chalk.protos.chalk.common.v1.Series, ai.chalk.protos.chalk.common.v1.Series.Builder, ai.chalk.protos.chalk.common.v1.SeriesOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:chalk.common.v1.Chart)
  }

  // @@protoc_insertion_point(class_scope:chalk.common.v1.Chart)
  private static final ai.chalk.protos.chalk.common.v1.Chart DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ai.chalk.protos.chalk.common.v1.Chart();
  }

  public static ai.chalk.protos.chalk.common.v1.Chart getDefaultInstance() {
